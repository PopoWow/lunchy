...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { description: @dish.description, name: @dish.name, price: @dish.price, waiter_id: @dish.waiter_id }
    end
  ...
  test "should update dish" do
    put :update, id: @dish, dish: { description: @dish.description, name: @dish.name, price: @dish.price, waiter_id: @dish.waiter_id }
    assert_redirected_to dish_path(assigns(:dish))
  end
